...
public class LastNameFirstFormat implements Format{
        private List data;

        public LastNameFirstFormat(String file){
        ...
        public String getGuestDetail(){
            ...
            while (i < data.size()) {
                ...
                if(guestDetail[2].equals("Male")){
                    result +="Mr "+guestDetail[1]+" "+guestDetail[0];
                } else{
                    result +="Ms "+guestDetail[1]+" "+guestDetail[0];
                }
                if (i < data.size()-1)
                    result+="\n";
                i++;
